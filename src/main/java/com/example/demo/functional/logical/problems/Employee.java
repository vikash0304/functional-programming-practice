...
public class Employee {
    ...
    double salary;
    /**
     * employees whose salary is greater than avg-sal of there department
     */
    ...
    public static void main(String[] args) {
        List<Employee> employeeList = setemployees();

        Map<String, Double> mapDeptSalary = employeeList.stream().collect(Collectors.groupingBy(Employee::getDepartment, Collectors.averagingDouble(Employee::getSalary)));
        List<Employee> employeeSalaryGreaterThanaverage = employeeList.stream().filter(e -> e.getSalary() > mapDeptSalary.get(e.getDepartment())).collect(Collectors.toList());
    }
